...
| R0b | ProcTHOR single | 000, 001, 002, 003 | explicitly off | omitted | terminal (Hope 56100913) | invalid | all four external timeouts at 3600s; no actions, turns, communications, or model calls | ProcTHOR hung immediately after local scene data loaded; diagnose environment startup before harness iteration |
...
| R1 | AI2-THOR dual | 03044, 03054, 03064, 03075 | enabled | omitted | terminal failed (Hope 56107673) | invalid | four worker attempts failed before benchmark output; minimal Hope payload retained /workdir at 127 GB | Recover launch stderr before retrying this configuration |
